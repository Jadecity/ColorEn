function weight = gen_nn_distance(data, num_neighbors, block_size, save_type)
...
disp(['Nei: ', num2str(num_neighbors)]);
disp( 'Size A: ' );
whos A
drawnow('update');
weight = A;
...
%% the following code is ignored by the 'return' above caus don't want to save data
%
